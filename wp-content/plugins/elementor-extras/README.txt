...
Elementor Extras is a premium Wordpress plugin for Elementor, extending its capability with seriously useful and unique widgets and extensions

== Description ==

Elementor Extras is a premium Wordpress plugin for Elementor. It extends its capability with a lot of unique widgets and extensions that make Elementor even more powerful. Widgets like Switcher, Timeline and Hotspots, together with tooltips, parallax elements and sticky elements will give you an edge in designing your Wordpress website.
